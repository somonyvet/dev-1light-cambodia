    ...
    return (
        <div className="container text-center">
            {data && <>
                    ...
                    <div className="mt-3 flex gap-3 overflow-x-auto">
                        {data.images.map((image: string, index: number) => (
                            <div key={index}
                                ...
                                <Image src={image} alt="thumbnail" className="object-cover transition-all duration-100 group-hover:scale-105" fill/>
                                <div
                                    ...
                                    <Image src="/icons/view.svg" alt="view" width={24} height={24} priority className="mx-auto"/>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="mt-5">
                    <div className="text-start" dangerouslySetInnerHTML={{__html: data.content}}></div>
                </div>
                <div
                    ...
                    <div className="mx-auto max-w-[600px] w-full z-20 space-y-5 px-3">
                        ...
                        <Image src={data.images[activeIndex]} alt="img" width={100} height={100}
